package co.istad.testmobilebankingapi.init;
...
import co.istad.testmobilebankingapi.features.user.AuthorityRepository;
import co.istad.testmobilebankingapi.features.user.RoleRepository;
